...
// GIFTASTIC! 
var topics = ["Beyonce", "Sip Tea", "That's Cool", "Sleepy", "no", "Wow", "C'mon", "Awesome", "Winning", "Water", "Kittens", "Puppies", "Really"];

var button;
var newTopic = ""; // new topic added via the input field 
...
// User clicks on a button, which generates 10 static gif images from the GIPHY API. 
...
// When the user clicks one of the still GIPHY images, it animates. When the user clicks the gif again, it stops playing.
